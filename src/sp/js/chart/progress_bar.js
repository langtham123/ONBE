...
function setCommentItem(comment,avatar) {
    ...
    html +='<div class="commentItemRight"><a href="#" class="iconBall"><img src="/images/onb/2019/sp/commentFunction.png" alt=""></a><p class="textAuthor">吉野 次郎</p> <p class="textAuthorTitle">日本経済新聞社記者</p> <div class="commentItemRightContent on">'+lines.join('')+'</div> <div class="commentIcon"><span class="commentTime">0分前</span><span class="commentlike"><a href="#"><i class="icon iconLike"></i>0</a></span><span class="commentReply"><a href="#">返信</a></span><span class="commentVoteLike"><a href="#">いいね！</a></span></div> </div>';
